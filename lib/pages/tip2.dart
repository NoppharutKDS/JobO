...
class TipPage_2 extends StatefulWidget {
  const TipPage_2({super.key});

  @override
  _TipPage_2 createState() => _TipPage_2();  
}
class _TipPage_2 extends State<TipPage_2> {
              ...
              Column(
                ...
                children: [
                  ...
                  Text("Let’s us help you find \n your dream job", style: TextStyle(
                          ...
                          Text("Find internship near you or you can \n find which are on trend \n <Require GPS activation>", style: TextStyle(
